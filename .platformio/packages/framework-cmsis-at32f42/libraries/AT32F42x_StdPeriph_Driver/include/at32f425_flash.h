...
#define USD_DEPSLP_WDT_NO_STOP           ((uint16_t)0x0020) /*!< wdt continue count when entering in deepsleep */
#define USD_DEPSLP_WDT_STOP              ((uint16_t)0x0000) /*!< wdt stop count when entering in deepsleep */

#define USD_STDBY_WDT_NO_STOP            ((uint16_t)0x0040) /*!< wdt continue count when entering in standby */
